...
const NATIVE_REV = 7; // v0.18.0 — PlayerActivity: episodes sheet + prev/next, honest cinema switch (switchToWeb), zoom cycle, sleep timer, speed 0.25–3×, MediaSession + artwork → APK required for every user on ≤ rev 6
