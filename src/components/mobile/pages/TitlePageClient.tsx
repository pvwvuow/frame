    ...
    return (
      <main className="pb-16">
        <div className="relative min-h-[88vh] overflow-hidden">
          ...
          <div className="relative mx-auto max-w-[1600px] px-4 pt-56 sm:px-8 lg:px-12">
            <div className="h-12 w-80 max-w-full animate-pulse rounded-xl bg-white/10" />
            <div className="mt-4 h-4 w-52 animate-pulse rounded bg-white/5" />
          </div>
        </div>
      </main>
    );
