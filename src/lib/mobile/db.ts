...
export const GENRES = [
  ...
  // v0.32.0 — کاتالوگ واقعی این ژانرها را هم دارد؛ تا امروز ~۲٬۶۰۰ عنوان
  // (انیمیشن/مستند/فانتزی/…) روی صفحه‌ی ژانرها و فیلترها دیده نمی‌شدند.
  "فانتزی", "انیمیشن", "مستند", "خانوادگی", "زندگینامه‌ای", "موزیکال", "موسیقی", "وسترن", "ورزشی", "رئالیتی",
];
