  ...
  return (
    <InfoPage current="/terms" icon={ShieldIcon} eyebrow="توافق‌نامه" title="قوانین استفاده" lead="با استفاده از نما، شرایط زیر را می‌پذیرید. سعی کرده‌ایم ساده و بدون پیچیدگی بنویسیم.">
      <Section title="۱. استفاده شخصی">
        <p>محتوای فریم برای تماشای شخصی و غیرتجاری ارائه می‌شود. بازپخش عمومی، دانلود غیرمجاز یا بازنشر محتوا مجاز نیست.</p>
      </Section>
      ...
      <Section title="۳. محتوای کاربران">
        <p>نقد و نظرهایی که ثبت می‌کنید باید محترمانه و بدون توهین باشد. فریم می‌تواند محتوای نامناسب را حذف کند.</p>
      </Section>
      ...
      <Section title="۵. تغییر سرویس">
        <p>ممکن است امکانات فریم بدون اطلاع قبلی تغییر کند یا گسترش یابد. تلاش می‌کنیم تغییرات مهم را اطلاع‌رسانی کنیم.</p>
      </Section>
    </InfoPage>
  );
}
